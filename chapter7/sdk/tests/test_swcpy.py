...
load_dotenv("/workspaces/portfolio-project/chapter7/sdk/.env")

# Debug print to confirm the variable is available
print(f"SWC_BASE_URL in test_swcpy.py after load_dotenv: {os.getenv('SWC_BASE_URL')}")
...
def test_environment_variable():
    ...
    swc_base_url = os.getenv('SWC_BASE_URL')
